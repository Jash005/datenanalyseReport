...
>> Crash_Date und Crash_hour sind etwas wiedersprüchliche Angaben. sie sind verschieden sollen aber das gleiche Zeigen. hier müssen wir entschiden wie wir damit umgehen, auf welche Uhrzeit velassen wir uns hier? Antowrt: wir extrahieren die Uhrzeit und den wochentag aud dem Crash_date, weil in der spalte crash_hour einem bestimmten schema folgt und bevor das überstezt und transormiert wird ist es leichter es aus dem crash_date heruaszuextrahieren (das muss eh beaneberitet werden). somit würde die spalte crash_hour wegfallen
